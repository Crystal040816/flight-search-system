...
-----------------------------------------------------------------------------
* 请求方法：GET
* 请求路径：/api/search/cities/destinations
...
-----------------------------------------------------------------------------
* 请求方法：GET
* 请求路径：/api/search/airports/origins
...
-----------------------------------------------------------------------------
* 请求方法：GET
* 请求路径：/api/search/airports/destinations
